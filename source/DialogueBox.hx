...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>, ?targetColor:String = '0xFFB3DFd8')
	{
		super();
		...
		bgFade = new FlxSprite(-200, -200).makeGraphic(2, 2, bgColor);
		bgFade.scale.set(FlxG.width*1.3, FlxG.height*1.3);
