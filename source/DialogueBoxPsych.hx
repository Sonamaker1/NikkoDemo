...
typedef DialogueCharacterFile = {
	...
	var overlayBGcolor:Array<Float>;
}
...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null, ?targetColor:String = '0xFFFFFFFF')
	{
		super();
