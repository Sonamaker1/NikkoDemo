...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		healthBarBG.alpha = ClientPrefs.hideHud?0.00001:1;
		healthBarBG.xAdd = -4;
		healthBarBG.yAdd = -4;
		add(healthBarBG);
		...
		// healthBar
		healthBar.alpha = ClientPrefs.hideHud?0.00001:ClientPrefs.healthBarAlpha;
		add(healthBar);
		healthBarBG.sprTracker = healthBar;

		iconP1 = new HealthIcon(boyfriend.healthIcon, true);
		iconP1.y = healthBar.y - 75;
		iconP1.alpha = ClientPrefs.hideHud?0.00001:ClientPrefs.healthBarAlpha;
		add(iconP1);

		iconP2 = new HealthIcon(dad.healthIcon, false);
		iconP2.y = healthBar.y - 75;
		iconP2.alpha = ClientPrefs.hideHud?0.00001:ClientPrefs.healthBarAlpha;
		add(iconP2);
		...
		scoreTxt.alpha = ClientPrefs.hideHud?0.00001:1;
		add(scoreTxt);
	...
	public function startDialogue(dialogueFile:DialogueFile, ?song:String = null, ?bgcolor:String = null):Void
	{
		if(song == ''){
			song = null;
		}
		...
		if(dialogueFile.dialogue.length > 0) {
			...
			psychDialogue = new DialogueBoxPsych(dialogueFile, song, bgcolor);
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		rating.alpha = (ClientPrefs.hideHud || !showRating)?0.00001:1;
		...
		comboSpr.alpha = (ClientPrefs.hideHud || !showCombo)?0.00001:1;
		...
		for (i in seperatedScore)
		{
			...
			numScore.alpha = ClientPrefs.hideHud?0.00001:1;
