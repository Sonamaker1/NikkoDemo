...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function updateWaveform() {
		...
		var index:Int = Std.int(sectionStartTime() * 44.100 * sampleMult);
		...
		var samplesPerRow:Int = Std.int(((Conductor.stepCrochet * steps * sampScale * sampleMult) / 16) / zoomList[curZoom]);
		trace(samplesPerRow);
